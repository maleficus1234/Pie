...
namespace JasonBell.Pie_VisualStudio
{
    ...
    public class PieConsoleProjectNode : ProjectNode
    {
        ...
        /// </summary>
        static PieConsoleProjectNode()
        {
            imageList = Utilities.GetImageList(typeof(PieConsoleProjectNode).Assembly.GetManifestResourceStream("Microsoft.VisualStudio.Project.Samples.CustomProject.Resources.MyCustomProjectImageList.bmp"));
        }
        ...
        public PieConsoleProjectNode(PiePackage package)
        {
        ...
        {
            get { return typeof(PieConsoleProjectFactory).GUID; }
        }
